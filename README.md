...
O objetivo é fazer com que a função `IdentifyBiggestNumber` encontre o maior número dentre os passados por parâmetro e testar se o comportamento é o esperado.
